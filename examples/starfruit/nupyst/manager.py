...
class Manager(object):
    ...
    def queueadd(self, queue, interface, membername='', penalty='', paused='', actionid = ''):
        """queueadd:
    ...
    def queuepause(self, interface, paused, queue = '', actionid = ''):
        """queuepause:
    ...
    def queueremove(self, queue, interface, actionid = ''):
        """queueremove:
